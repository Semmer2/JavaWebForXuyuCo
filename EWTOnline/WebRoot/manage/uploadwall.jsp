...
<html>
  <head>
	...
	function uploadsuccess(id)
	{
		...
		{
			parentwindow.onAfterUploadWall(id);	
		}
	}
	</script>
  </head>
<body scroll="no">
	<form action='../servlet.jsp?action=wallimage&method=new' enctype="multipart/form-data" method='post' style="margin: 0px" target='postfrm' name="dataform">
	<table align='center' width='100%' border='1' cellpadding='1' cellspacing='0' bordercolorlight='#25689F' bordercolordark='#ffffff'>
		<tr>
			<td align="center" class='cuteLable' colspan="2">请选择图片文件</td>			
		</tr>
		<tr>
			<td align="center" class='cuteLable' width="40%">图片名称</td>
			<td>			
			<input type='text' id='imagename' name='imagename' size="30" value=""/>				
			</td>
		</tr>
		<tr>
			<td align="center" class='cuteLable' width="40%">文件</td>
			<td>			
